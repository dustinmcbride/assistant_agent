...
from tools.email import fetch_thread_body, send_email, store_pending_email
from tools.obsidian import add_todo, list_vault_files, read_file, write_trip_file
from tools.trello import TRELLO_API_KEY, TRELLO_TOKEN
...
def notify_email(sender: str, subject: str, body: str, thread_id: str, message_id: str) -> None:
    ...
    try:
        ...
        ref = store_pending_email(thread_id, message_id, sender, subject)
